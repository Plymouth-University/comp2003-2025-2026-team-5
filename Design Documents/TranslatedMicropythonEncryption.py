...
#encrypt using exchanged keys
def encrypt_message(my_priv, peer_pub, msg):
    
    my_pub = my_priv * curve.g
    ...
    return {
        ...
        "tag": tag,
        "nonce": nonce,
        "peer_pub": (my_pub.x, my_pub.y)
    }

#decrypt using exchanged keys
def decrypt_message(my_priv, data):
    x, y = data["peer_pub"]
    peer_pub = Point(curve, x, y)
...
#test routine - generated with co piolt
alice_priv, alice_pub = gen_ecdh()
bob_priv, bob_pub = gen_ecdh()

msg = b"hello"

encrypted = encrypt_message(alice_priv, bob_pub, msg)
print("Encrypted:", encrypted)

decrypted = decrypt_message(bob_priv, encrypted)
print("Decrypted:", decrypted)

encrypted2 = encrypt_message(alice_priv, bob_pub, b"hello2")
print("Encrypted:", encrypted2)

decrypted2 = decrypt_message(bob_priv, encrypted2)
